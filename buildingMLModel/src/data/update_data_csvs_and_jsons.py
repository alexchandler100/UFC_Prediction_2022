...
#At the end, we have files fight_hist.csv and fighter_stats.csv which we can use to construct a dataframe in
#building_ufc_fights and building_ufc_fighters
...
csvFilePath = r'fighter_stats.csv'
...
ufcfightscrap_for_json.to_csv('ufcfightscrap.csv', index = False)

#convert fighter_stats.csv to json files to read via javascript in website
csvFilePath = r'ufcfightscrap.csv'
jsonFilePath = r'ufcfightscrap.json'
