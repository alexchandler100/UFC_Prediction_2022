...
and press enter to serve html via a local host. Now go to chrome and type localhost:8000 into the address bar. This opens the updated version of the website.
