...
STATISTIC_EXTRACTORS: tuple[tuple[str, Callable[[SimulationPath], float]], ...] = (
    ...
    ("red_landed_exchanges", lambda path: float(path.mechanic_count("red_landed_exchanges"))),
    ("blue_landed_exchanges", lambda path: float(path.mechanic_count("blue_landed_exchanges"))),
    ("red_hurt_events", lambda path: float(path.mechanic_count("red_hurt_events"))),
    ("blue_hurt_events", lambda path: float(path.mechanic_count("blue_hurt_events"))),
    ("red_knockdown_recoveries", lambda path: float(path.mechanic_count("red_knockdown_recoveries"))),
    ("blue_knockdown_recoveries", lambda path: float(path.mechanic_count("blue_knockdown_recoveries"))),
    ("red_ko_after_knockdown", lambda path: float(path.mechanic_count("red_ko_after_knockdown"))),
    ("blue_ko_after_knockdown", lambda path: float(path.mechanic_count("blue_ko_after_knockdown"))),
    ("red_ko_without_knockdown", lambda path: float(path.mechanic_count("red_ko_without_knockdown"))),
    ("blue_ko_without_knockdown", lambda path: float(path.mechanic_count("blue_ko_without_knockdown"))),
    ("red_ground_stoppages", lambda path: float(path.mechanic_count("red_ground_stoppages"))),
    ("blue_ground_stoppages", lambda path: float(path.mechanic_count("blue_ground_stoppages"))),
    ("red_submission_finishes", lambda path: float(path.mechanic_count("red_submission_finishes"))),
    ("blue_submission_finishes", lambda path: float(path.mechanic_count("blue_submission_finishes"))),
