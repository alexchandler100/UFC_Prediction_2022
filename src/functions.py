...
fight_hist = pd.read_csv('content/data/processed/fight_hist.csv', sep=',', low_memory=False)
...
fighter_stats = pd.read_csv('content/data/processed/fighter_stats.csv', sep=',', low_memory=False)
# TODO FIGURE OUT THE DIFFERENCE BETWEEN ufc_fights_crap and ufc_fights, and fight_hist
ufc_fights = pd.read_csv('content/data/processed/ufc_fights.csv', low_memory=False)
